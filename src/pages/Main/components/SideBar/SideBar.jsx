...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            <div
                className={`
                    fixed inset-0 bg-black/40 bg-opacity-30 z-40 transition-opacity
            ...
            <aside
                ...
                className={`
                    ...
                    bg-gray-50 fixed top-0 right-0 h-full w-64 z-50 transform
                        ...
                        {products.cats.map((cat) => (
                            <li key={cat.cat_id}>
                                <button
                                    ...
                                    className={`
                                        w-full text-right p-4 rounded-lg transition-all
